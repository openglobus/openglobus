...
goog.addDependency('../../../openglobus/src/og/bv/box.js', ['og.bv.Box'], ['og.bv', 'og.math.Vector3']);
goog.addDependency('../../../openglobus/src/og/bv/bv.js', ['og.bv'], ['og.extent', 'og.geo', 'og.math']);
goog.addDependency('../../../openglobus/src/og/bv/sphere.js', ['og.bv.Sphere'], ['og.bv', 'og.math.Vector3']);
...
goog.addDependency('../../../openglobus/src/og/control/loadingSpinner.js', ['og.control.LoadingSpinner'], ['og._class_', 'og.control.Control']);
...
goog.addDependency('../../../openglobus/src/og/control/mousePosition.js', ['og.control.MousePosition'], ['og._class_', 'og.control.Control', 'og.geo', 'og.planetSegment']);
...
goog.addDependency('../../../openglobus/src/og/geo.js', ['og.geo'], []);
...
goog.addDependency('../../../openglobus/src/og/node/skyBox.js', ['og.node.SkyBox'], ['og.node.Node3D', 'og.webgl']);
goog.addDependency('../../../openglobus/src/og/og.js', ['og'], []);
goog.addDependency('../../../openglobus/src/og/planetSegment/planetSegment.js', ['og.planetSegment', 'og.planetSegment.PlanetSegment'], ['og.bv.Box', 'og.bv.Sphere', 'og.extent', 'og.geo', 'og.layer', 'og.math', 'og.math.Vector3', 'og.planetSegment.PlanetSegmentHelper']);
...
goog.addDependency('../../../openglobus/src/og/shaderProgram/callbacks.js', ['og.shaderProgram.callbacks'], ['og.shaderProgram.types']);
goog.addDependency('../../../openglobus/src/og/shaderProgram/shaderProgram.js', ['og.shaderProgram.ShaderProgram'], ['og.shaderProgram.callbacks']);
goog.addDependency('../../../openglobus/src/og/shaderProgram/types.js', ['og.shaderProgram.types'], []);
...
goog.addDependency('../../../openglobus/src/og/utils/utils.js', ['og.utils'], ['og.Ajax']);
goog.addDependency('../../../openglobus/src/og/webgl/handler.js', ['og.webgl.Handler'], ['og.math', 'og.webgl']);
goog.addDependency('../../../openglobus/src/og/webgl/webgl.js', ['og.webgl'], ['og.utils']);
