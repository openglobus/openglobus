...
const tg = new CanvasTiles("Tile grid", {
    visibility: true, isBaseLayer: false, //maxNativeZoom: 7,
    //animated: true,
    preLoadZoomLevels: [0], drawTile: function (material, applyCanvas) {
...
let sat = new XYZ("sat", {
    ...
    url: "https://ecn.{s}.tiles.virtualearth.net/tiles/a{quad}.jpeg?n=z&g=7146", //url: "https://astro.arcgis.com/arcgis/rest/services/OnMars/MDIM/MapServer/tile/{z}/{y}/{x}?blankTile=false",
    ...
    maxNativeZoom: 19,
    defaultTextures: [{ color: "#001522" }, { color: "#E4E6F3" }], //textureFilter: "linear",
    ...
    nightTextureCoefficient: 2.7, //ambient: "rgb(77,77,128)",
    urlRewrite: function (s, u) {
        return stringTemplate(u, {
...
var globus = new Globe({
    //autoActivate: false,
    target: "earth4", name: "Earth", //frustums: [[100, 100000000]],
    maxAltitude: 15000000, //minAltitude: 1,
    ...
    layers: [osm, clouds], //frustums: [[1, 1e3 + 100], [1e3, 1e6 + 10000], [1e6, 1e9]],
...
const entity = new Entity({
    lonlat: [0, 0], geoObject: {
        scale: 1, color: "yellow", instanced: true, object3d: obj3d
    }
});
...
let geoObjects = new EntityCollection({
    entities: [entity], scaleByDistance: [100, 20000000, 1.0]
});
...
var globus2 = new Globe({
    autoActivate: false, //target: "earth4",
    name: "Earth", //frustums: [[100, 100000000]],
    maxAltitude: 15000000, //minAltitude: 1,
    //terrain: highResTerrain,
    //terrain: new MapboxTerrain(),
    terrain: new GlobusTerrain("19", {
    ...
    //maxEqualZoomAltitude: 1,
    layers: [sat2], //frustums: [[1, 1e3 + 100], [1e3, 1e6 + 10000], [1e6, 1e9]],
    //useNightTexture: false,
    //useEarthNavigation: true,
    //useSpecularTexture: false
});