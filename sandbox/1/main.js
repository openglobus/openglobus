...
function start() {
    ...
    var satlayer = new og.layer.XYZ("MapQuest Satellite", { isBaseLayer: true, url: "http://otile1.mqcdn.com/tiles/1.0.0/sat/{zoom}/{tilex}/{tiley}.jpg", visibility: true, zIndex: 1, attribution: '<img src="http://content.mqcdn.com/winston-618/cdn/toolkit/lite/images/questy.png">' });
