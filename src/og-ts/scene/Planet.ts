...
export class Planet extends RenderNode {
    ...
    layers: any[];
    visibleTileLayers: any[];
    visibleVectorLayers: any[];
    _visibleTileLayerSlices: any[];
    _frustumEntityCollections: any[];
    baseLayer: any;
    terrain: any;
    camera: any;
    _minAltitude: any;
    ...
    _textureCoordsBufferCache: any[];
    _heightPickingFramebuffer: any;
    _quadTree: any;
    _quadTreeNorth: any;
    _quadTreeSouth: any;
    _nightTexture: any;
    _specularTexture: any;
    _ambient: Float32Array;
    _diffuse: Float32Array;
    _specular: Float32Array;
    _useNightTexture: any;
    _useSpecularTexture: any;
    _maxGridSize: number;
    SLICE_SIZE: number;
    SLICE_SIZE_4: number;
    SLICE_SIZE_3: number;
    ...
    _geoImageCreator: any;
    _vectorTileCreator: any;
    _normalMapCreator: any;
