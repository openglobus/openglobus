 ...
 */
class Events {
    layervisibilitychange(layervisibilitychange: any, layer: any) {
        throw new Error("Method not implemented.");
    }
    baselayerchange(baselayerchange: any, layer: any) {
        throw new Error("Method not implemented.");
    }
    rendercompleted(rendercompleted: any, arg1: boolean) {
        throw new Error("Method not implemented.");
    }
    draw(draw: any, arg1: this) {
        throw new Error("Method not implemented.");
    }
    _eventNames: any[];
    _sender: any;
