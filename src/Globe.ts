...
class Globe {
    ...
    constructor(options: IGlobeParams) {
        ...
        this.planet = new Planet({
            ...
            nightTextureSrc: options.nightTextureSrc != null ? options.nightTextureSrc : `${options.resourcesSrc || DEFAULT_RESOURCES_SRC}${DEFAULT_NIGHT_SRC}`,
            specularTextureSrc: options.specularTextureSrc != null ? options.specularTextureSrc : `${options.resourcesSrc || DEFAULT_RESOURCES_SRC}${DEFAULT_SPEC_SRC}`,
