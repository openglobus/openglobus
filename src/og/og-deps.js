...
goog.addDependency('../../../og/src/og/control/spinNavigation.js', ['og.SpinNavigation'], ['og.bv.Sphere', 'og.control.Control', 'og.inheritance', 'og.math', 'og.math.Matrix4', 'og.math.Quaternion', 'og.math.Ray', 'og.math.Vector3'], false);
goog.addDependency('../../../og/src/og/control/sun.js', ['og.control.Sun'], ['og.astro.earth', 'og.control.Control', 'og.inheritance', 'og.light.PointLight', 'og.math.Quaternion'], false);
...
goog.addDependency('../../../og/src/og/node/planetAtmosphere.js', ['og.node.PlanetAtmosphere'], ['og.inheritance', 'og.shaderProgram.atmosphereSpace', 'og.shaderProgram.overlaysAtmosphere_nl', 'og.shaderProgram.overlaysAtmosphere_wl', 'og.shaderProgram.singleAtmosphere_nl', 'og.shaderProgram.singleAtmosphere_wl', 'og.shape.Icosphere'], false);
...
goog.addDependency('../../../og/src/og/webgl/handler.js', ['og.webgl.Handler'], ['og.Clock', 'og.Console', 'og.ImageCanvas', 'og.math', 'og.math.Pixel', 'og.webgl', 'og.webgl.ShaderController'], false);
