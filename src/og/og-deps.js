...
goog.addDependency('../../../og/src/og/node/planet.js', ['og.node.Planet'], ['og', 'og.bv.Sphere', 'og.layer', 'og.math.Matrix4', 'og.math.Vector3', 'og.node.Node3D', 'og.planetSegment', 'og.quadTree', 'og.quadTree.QuadNode', 'og.shaderProgram.overlays', 'og.shaderProgram.single']);
