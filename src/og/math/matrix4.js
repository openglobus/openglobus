...
og.math.Matrix4.prototype.mul = function (m) {
    ...
    var A = m._m[0], B = m._m[1], t = m._m[2], u = m._m[3],
        v = m._m[4], w = m._m[5], x = m._m[6], y = m._m[7],
        z = m._m[8], C = m._m[9], D = m._m[10], E = m._m[11],
        q = m._m[12], F = m._m[13], G = m._m[14]; b = m._m[15];
