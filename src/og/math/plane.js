goog.provide('og.math.Plane');

goog.require('og.math.Vector3');

og.math.Plane = function (p, n) {
    this.p = (p ? p.clone() : new og.math.Vector3());
    this.n = (n ? n.clone() : new og.math.Vector3());
};

og.math.Plane.prototype.set = function (p, n) {
    this.p.copy(p);
    this.n.copy(n);
};

og.math.Plane.prototype.getNormal = function () {
    return this.n;
};

og.math.Plane.getIntersection = function (Pn1, Pn2, L) {
    ...
    if ((ax + ay + az) < og.math.EPSILON5) {  // Pn1 and Pn2 are near parallel
    ...
    var iP = new og.math.Vector3(); // intersect point
