...
og.math.coder.encodeFloatToRGBA = function (f) {
    ...
    return new og.math.Vector4(
		128.0 * s + Math.floor(e * 0.5/*og.math.exp2(-1.0)*/),
		128.0 * og.math.mod(e, 2.0) + og.math.mod(Math.floor(m * 128.0), 128.0),
        Math.floor(og.math.mod(Math.floor(m * 32768/*og.math.exp2(23.0 - 8.0)*/), 256/*og.math.exp2(8.0)*/)),
        Math.floor(8388608.0/*og.math.exp2(23.0)*/ * og.math.mod(m, 0.000030517578125/*og.math.exp2(-15.0)*/))
	);
};
...
og.math.coder.decodeFloatFromRGBA = function (rgba) {
    ...
    return s * og.math.exp2(e) * (m * 1.1920928955078125e-7/*og.math.exp2(-23.0)*/);
};
