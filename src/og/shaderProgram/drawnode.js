...
goog.provide('og.shaderProgram.drawnode_colorPicking_nl');
goog.provide('og.shaderProgram.drawnode_heightPicking_nl');

goog.provide('og.shaderProgram.drawnode_wl');
goog.provide('og.shaderProgram.drawnode_screen_wl');
goog.provide('og.shaderProgram.drawnode_colorPicking_wl');
goog.provide('og.shaderProgram.drawnode_heightPicking_wl');
...
og.shaderProgram.drawnode_colorPicking_nl = function () {
    return new og.shaderProgram.ShaderProgram("drawnode_colorPicking_nl", {
        uniforms: {
            projectionViewMatrix: { type: og.shaderProgram.types.MAT4 },
            samplerCount: { type: og.shaderProgram.types.INT },
            tileOffsetArr: { type: og.shaderProgram.types.VEC4 },
...
og.shaderProgram.drawnode_heightPicking_nl = function () {
    return new og.shaderProgram.ShaderProgram("drawnode_heightPicking_nl", {
        uniforms: {
            projectionViewMatrix: { type: og.shaderProgram.types.MAT4 },
            samplerCount: { type: og.shaderProgram.types.INT },
            tileOffsetArr: { type: og.shaderProgram.types.VEC4 },
...
og.shaderProgram.drawnode_colorPicking_wl = function () {
    return new og.shaderProgram.ShaderProgram("drawnode_colorPicking_wl", {
        uniforms: {
            projectionMatrix: { type: og.shaderProgram.types.MAT4 },
            viewMatrix: { type: og.shaderProgram.types.MAT4 },
            samplerCount: { type: og.shaderProgram.types.INT },
...
\
                ...
                float emptiness = t.a * smoothstep(0.35, 0.5, distance( t.rgb, transparentColorArr[0].rgb ));\
                emptiness = step(1.0, emptiness);\
                gl_FragColor = vec4(pickingColorArr[0], emptiness);\
                if( samplerCount == 1 ) return;\
\
\
\
...
\
                ...
                emptiness = t.a * smoothstep(0.35, 0.5, distance( t.rgb, transparentColorArr[1].rgb ));\
                emptiness = step(1.0, emptiness);\
                gl_FragColor = mix( gl_FragData[1], vec4(pickingColorArr[1], 1.0), emptiness);\
                if( samplerCount == 2 ) return;\
\
\
\
...
\
                ...
                emptiness = t.a * smoothstep(0.35, 0.5, distance( t.rgb, transparentColorArr[2].rgb ));\
                emptiness = step(1.0, emptiness);\
                gl_FragColor = mix( gl_FragData[1], vec4(pickingColorArr[2], 1.0), emptiness);\
                if( samplerCount == 3 ) return;\
\
\
\
...
\
                ...
                emptiness = t.a * smoothstep(0.35, 0.5, distance( t.rgb, transparentColorArr[3].rgb ));\
                emptiness = step(1.0, emptiness);\
                gl_FragColor = mix( gl_FragData[1], vec4(pickingColorArr[3], 1.0), emptiness);\
                if( samplerCount == 4 ) return;\
\
\
\
...
\
                ...
                emptiness = t.a * smoothstep(0.35, 0.5, distance( t.rgb, transparentColorArr[4].rgb ));\
                emptiness = step(1.0, emptiness);\
                gl_FragColor = mix( gl_FragData[1], vec4(pickingColorArr[4], 1.0), emptiness);\
            }'
    });
};

og.shaderProgram.drawnode_heightPicking_wl = function () {
    return new og.shaderProgram.ShaderProgram("drawnode_heightPicking_wl", {
        uniforms: {
            projectionMatrix: { type: og.shaderProgram.types.MAT4 },
            viewMatrix: { type: og.shaderProgram.types.MAT4 },
            samplerCount: { type: og.shaderProgram.types.INT },
...
\
                vec4 t = texture2D( defaultTexture, vTextureCoord.xy );\
                gl_FragColor = vec4(range24, gl_FragData[0].a);\
                if( samplerCount == 0 ) return;\
\
\
\
...
\
                ...
                float emptiness = t.a * smoothstep(0.35, 0.5, distance( t.rgb, transparentColorArr[0].rgb ));\
                emptiness = step(1.0, emptiness);\
                gl_FragColor = mix( gl_FragData[2], vec4(range24, 1.0), emptiness);\
                if( samplerCount == 1 ) return;\
\
\
\
