goog.provide('og.shaderProgram.sphericalBillboard');
goog.provide('og.shaderProgram.alignedAxisBillboard');
...
og.shaderProgram.sphericalBillboard = function () {
    return new og.shaderProgram.ShaderProgram("sphericalBillboard", {
        uniforms: {
        ...
        vertexShader: og.utils.readTextFile(og.shaderProgram.SHADERS_URL + "sphericalBillboard_vs.txt"),
        fragmentShader: og.utils.readTextFile(og.shaderProgram.SHADERS_URL + "sphericalBillboard_fs.txt")
    });
};

og.shaderProgram.alignedAxisBillboard = function () {
    return new og.shaderProgram.ShaderProgram("alignedAxisBillboard", {
        uniforms: {
            u_texture: { type: og.shaderProgram.types.SAMPLER2D },
            uPMatrix: { type: og.shaderProgram.types.MAT4 },
            uMVMatrix: { type: og.shaderProgram.types.MAT4 },
        ...
        vertexShader: og.utils.readTextFile(og.shaderProgram.SHADERS_URL + "alignedAxisBillboard_vs.txt"),
        fragmentShader: og.utils.readTextFile(og.shaderProgram.SHADERS_URL + "alignedAxisBillboard_fs.txt")
    });
};