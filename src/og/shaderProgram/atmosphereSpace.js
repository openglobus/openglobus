...
og.shaderProgram.atmosphereSpace = function () {
    return new og.shaderProgram.ShaderProgram("atmosphereSpace", {
        ...
        vertexShader: og.utils.readTextFile(og.shaderProgram.SHADERS_URL + "atmosphereSpace_vs.txt"),
        fragmentShader: og.utils.readTextFile(og.shaderProgram.SHADERS_URL + "atmosphereSpace_fs.txt")
    });
};