 ...
 */
og.Frustum.planeNormalize = function (plane) {
...
og.Frustum.prototype.setFrustum = function (clip) {
    ...
    og.Frustum.planeNormalize(this._f[0]);
    ...
    og.Frustum.planeNormalize(this._f[1]);
    ...
    og.Frustum.planeNormalize(this._f[2]);
    ...
    og.Frustum.planeNormalize(this._f[3]);
    ...
    og.Frustum.planeNormalize(this._f[4]);
    ...
    og.Frustum.planeNormalize(this._f[5]);
};

/**
 * Returns true if a point in the frustum.
 * @public
 * @param {og.math.Vector3} point - Cartesian point.
 * @returns {boolean}
 */
