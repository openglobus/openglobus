...
export interface IPolylineBatchParams {
    altitude?: number;
    thickness?: number;
    opacity?: number;
    color?: string;
...
class PolylineBatchRenderer {
    ...
    constructor(options: IPolylineBatchParams = {}) {
    ...
    public _setTexCoordArr(tcoordArrOrArrs: number[] | (number[] | null)[]) {
        ...
        PolylineBatchRenderer.setPathTexCoords(this._path3v, tcoordArrOrArrs, this._texCoordArr);
