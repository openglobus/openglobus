...
export const DEFAULT_PARAMS: AtmosphereParameters = {
    ATMOS_HEIGHT: 100000.0,
    RAYLEIGH_SCALE: 0.06, //0.086
    MIE_SCALE: 0.0045,
    GROUND_ALBEDO: 0.022,
    BOTTOM_RADIUS: 6356752.3142451793,
    EQUATORIAL_RADIUS: 6378137.0,
    rayleighScatteringCoefficient_0: 4.0,
    rayleighScatteringCoefficient_1: 11.6,
    rayleighScatteringCoefficient_2: 24.0, //42.0
